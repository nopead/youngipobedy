...
class Feedback(MyDeclarativeBase):
    ...
    full_name: Mapped[str] = mapped_column(String(100), nullable=False, comment="ФИО отправителя")
    email: Mapped[str] = mapped_column(String(255), nullable=False, comment="Почта отправителя")
